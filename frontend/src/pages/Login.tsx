...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      // Add some debugging to track the login flow
          ...
          <div className="w-full max-w-md">
            ...
            >
              ...
              <div className="mt-2 space-y-2">
                <button
                  onClick={() => fillDemoCredentials("admin@eduzone.com")}
                  className="text-blue-600 hover:underline w-full text-left"
                >
                  admin@eduzone.com / password123 (Admin)
                </button>
                <button
                  onClick={() => fillDemoCredentials("john.smith@eduzone.com")}
                  className="text-blue-600 hover:underline w-full text-left"
                >
                  john.smith@eduzone.com / password123 (Teacher)
                </button>
                <button
                  onClick={() =>
                    fillDemoCredentials("sarah.johnson@eduzone.com")
                  }
                  className="text-blue-600 hover:underline w-full text-left"
                >
                  sarah.johnson@eduzone.com / password123 (Parent)
                </button>
                <button
                  onClick={() => fillDemoCredentials("librarian@eduzone.com")}
                  className="text-blue-600 hover:underline w-full text-left"
                >
                  librarian@eduzone.com / password123 (Librarian)
                </button>
              </div>
            </motion.div>
          </div>
