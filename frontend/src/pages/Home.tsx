          ...
          <div className="px-8 md:px-16 lg:px-24 py-12 flex flex-col justify-center">
            ...
            >
              {user ? (
                <>
                  Welcome back,{" "}
                  <span className="font-semibold">{user.name}</span>! We're glad
                  to see you again at Frankfield Primary & Infant School.
                </>
              ) : (
                <>
                  Welcome to Frankfield Primary & Infant School, where we
                  believe education is the key to success. Our mission is to
                  provide a nurturing environment for our students to learn,
            ...
            >
              {user ? (
                <>
                  <Button
                    className="bg-blue-700 hover:bg-blue-800 text-white px-10 py-7 rounded-md text-lg font-medium transition-opacity duration-300 group"
